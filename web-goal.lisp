...
(defun create-goal-form ()
	(tag form (method 'post id 'createform)
			 (tag h3 ()
						(princ "Create Goal"))
			 (tag p ()
						(tag label (for 'name)
...
(defun create-todo-item-form ()
	(tag form (method 'post id 'createform)
			 ...
			 (tag p ()
						(tag label (for 'item)
								 (princ "Item<br>"))
						(tag textarea (rows '2 cols '50 wrap 'physical name 'createTodoItem))
						(princ "<br>")
...
(defun embed-css3 ()
	(tag style (type "text/css")
			 (progn
				 (format t "~%~%")
				 (princ "#HEADING {")
				 (princ "font-family: verdana, arial, sans-serif;")
				 (princ "background-color: #33FF33;")
				 (princ "color: #009900;")
				 (princ "margin: 0;")
				 (princ "padding: 0;")
				 (princ "}")
				 ...
				 (princ "}")
				 (format t "~%~%")
				 (princ "#MAINNAVIGATION ul {")
				 (princ "list-style: none;")
				 (princ "margin: 0;")
				 (princ "padding: 0;")
				 (princ "}")
				 (format t "~%~%")
				 (princ "#MAINNAVIGATION ul li {")
				 (princ "float: left;")
				 (princ "padding: 1px;")
				 (princ "}")
				 (format t "~%~%")
				 (format t "~%~%")
				 (princ "#MAINNAVIGATION ul li a {")
				 (princ "font-family: verdana, arial, sans-serif;")
				 (princ "display: blocK;")
				 (princ "width: 120px;")
				 (princ "padding: 2px 2px 2px 2px;")
				 (princ "background-color: #339933;")
				 (princ "color: #66FF66;")
				 (princ "text-decoration: none;")
				 (princ "}")
				 (format t "~%~%")
				 (princ "#MAINNAVIGATION ul li a:hover {")
				 (princ "background-color: #33FF33;")
				 (princ "color: #339933;")
				 (princ "}")
				 (format t "~%~%")
				 ...
				 (princ "}")
				 (format t "~%~%")
				 (princ "#GOALINFO ul li a {")
				 (princ "background-color: #339933;")
				 (princ "color: #66FF66;")
				 (princ "text-decoration: none;")
				 (princ "}")
				 (format t "~%~%")
				 (princ "#GOALINFO ul li a:hover {")
				 (princ "background-color: #33FF33;")
				 (princ "color: #339933;")
				 (princ "}")
				 (format t "~%~%")
				 ...
				 ;(princ "display: block;")
				 (princ "margin: 2px;")
				 (princ "background-color: #FF6666;")
				 (princ "color: #990000;")
				 (princ "text-decoration: none;")
				 (princ "}")
				 (format t "~%~%")
				 (princ "#DELETELINK a:hover {")
				 (princ "background-color: #990000;")
				 (princ "color: #FF6666;")
				 (princ "}")
				 (format t "~%~%")
				 (princ "#GOALNOTE {")
